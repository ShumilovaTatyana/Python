def write_txt(filename: str, data: list):
    with open(filename, 'w', encoding= 'uft-8') as fout:
...
def read_csv(filename: str) -> list:
    data = []
    fields = ["Фамилия", "Имя", "Телефон", "Специальность"]
...
def find_by_name(data: list, last_name: str) -> str:
    ...
    return "Такой студент отсутствует"
...
def add_student(data: list, user_data: str):
    fields = ["Фамилия", "Имя", "Телефон", "Специальность"]
